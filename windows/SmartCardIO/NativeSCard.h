...
public:
 ...
 static const std::wstring ALL_READERS;//!< Default winscard name for all readers group
 ...
 //! \fn GUID WinSCard::GetProviderId(const std::wstring& cardName)
 //! \brief Gets provider GUID.
 //! \exception SCardException Thrown when a Card error condition occurs and throwErrors is set true.
 //! \param[in] cardName Name of the card.
 //! \return The provider GUID.
 virtual GUID GetProviderId(const std::wstring& cardName);
 //! \fn std::vector<std::wstring> WinSCard::ListCards(const std::vector<BYTE>& cardAtr, const std::vector<GUID>& guidInterfaces)
 //! \brief Searches the smart card database and provides a list of named cards previously introduced to the system by the user. Match ATR an support the interfaces specified.
 //! \exception SCardException Thrown when a Card error condition occurs and throwErrors is set true.
 //! \param[in] cardAtr        The card ATR.
 //! \param[in] guidInterfaces The unique identifier interfaces.
 ...
 //! \fn std::vector<std::wstring> WinSCard::ListCards(const std::vector<GUID>& guidInterfaces)
 //! \brief Searches the smart card database and provides a list of named cards previously introduced to the system by the user. Search for interfaces specified.
 //! \exception SCardException Thrown when a Card error condition occurs and throwErrors is set true.
 //! \param guidInterfaces The unique identifier interfaces.
 //! \return A list of cards names
 virtual std::vector<std::wstring> ListCards(const std::vector<GUID>& guidInterfaces);
 //! \fn std::vector<std::wstring> WinSCard::ListCards(const std::vector<BYTE>& cardAtr)
 //! \brief Searches the smart card database and provides a list of named cards previously introduced to the system by the user. Match for ATR.
 //! \exception SCardException Thrown when a Card error condition occurs and throwErrors is set true.
 //! \param[in] cardAtr The card atr.
 //! \return A list of cards names
 virtual std::vector<std::wstring> ListCards(const std::vector<BYTE>& cardAtr);
 //! \fn std::vector<std::wstring> WinSCard::ListCards(void)
 //! \brief Searches the smart card database and provides a list of named cards previously introduced to the system by the user.
 //! \return A list of cards names
 virtual std::vector<std::wstring> ListCards(void);
 //! \fn std::vector<GUID> ListInterfaces(const std::wstring& cardName)
 //! \brief Provides a list of interfaces supplied by a given card.
 //! \exception SCardException Thrown when a Card error condition occurs and throwErrors is set true.
 //! \param[in] cardName Name of the card.
 //! \return Vector of interfaces supported by the card
 //! @}
 virtual std::vector<GUID> ListInterfaces(const std::wstring& cardName);
 //! \defgroup scdbmng_funcs Smart Card Database Management Functions
 //! @{
 //! \fn void WinSCard::AddReaderToGroup(const std::wstring& ReaderName, const std::wstring& GroupName)
 //! \brief Adds a reader to group to 'GroupName'.
 //! \exception SCardException Thrown when a Card error condition occurs and throwErrors is set true.
 //! \param[in] ReaderName Name of the reader.
 ...
 //! \fn void WinSCard::ForgetCardType(const std::wstring& cardName)
 //! \brief Removes an introduced smart card from the smart card subsystem
 //! \exception SCardException Thrown when a Card error condition occurs and throwErrors is set true.
 //! \param[in] cardName Name of the card.
 virtual void ForgetCardType(const std::wstring& CardName);
 //! \fn void WinSCard::ForgetReader(const std::wstring& ReaderName)
 //! \brief removes a previously introduced reader from control by the smart card subsystem. It is removed from the smart card database, including from any reader group that it may have been added to.
 //! \exception SCardException Thrown when a Card error condition occurs and throwErrors is set true.
 //! \param[in] ReaderName Name of the reader.
 virtual void ForgetReader(const std::wstring& ReaderName);
 //! \fn void WinSCard::ForgetReaderGroup(const std::wstring& GroupName)
 //! \brief Removes a previously introduced smart card reader group from the smart card subsystem. Although this function automatically clears all readers from the group, it does not affect the existence of the individual readers in the database.
 //! \exception SCardException Thrown when a Card error condition occurs and throwErrors is set true.
 //! \param[in] GroupName Name of the group.
 virtual void ForgetReaderGroup(const std::wstring& GroupName);
 //! \fn void WinSCard::IntroduceReader(const std::wstring& ReaderName, const std::wstring& DeviceName)
 //! \brief Introduces a new name for an existing smart card reader.
 //! \warning Smart card readers are automatically introduced to the system; a smart card reader vendor's setup program can also introduce a smart card reader to the system.
 //! \exception SCardException Thrown when a Card error condition occurs and throwErrors is set true.
 //! \param[in] ReaderName Name of the reader.
 ...
 //! \fn void WinSCard::IntroduceReaderGroup(const std::wstring& GroupName)
 //! \brief Introduces a reader group to the smart card subsystem. However, the reader group is not created until the group is specified when adding a reader to the smart card database.
 //! \exception SCardException Thrown when a Card error condition occurs and throwErrors is set true.
 //! \param[in] GroupName Name of the group.
 virtual void IntroduceReaderGroup(const std::wstring& GroupName);
 //! \fn void WinSCard::RemoveReaderFromGroup(const std::wstring& ReaderName, const std::wstring& GroupName)
 //! \brief Removes a reader from an existing reader group. This function has no effect on the reader.
 //! \exception SCardException Thrown when a Card error condition occurs and throwErrors is set true.
 //! \param[in] ReaderName Name of the reader.
 //! \param[in] GroupName  Name of the group.
 virtual void RemoveReaderFromGroup(const std::wstring& ReaderName, const std::wstring& GroupName);
 //! \fn void WinSCard::IntroduceCardType(const std::wstring& cardName, const std::vector<GUID>& guidInterfaces, const std::vector<BYTE>& cardAtr, const std::vector<BYTE>& cardAtrMask, LPCGUID pguidPrimaryProvider)
 //! \brief Introduces a smart card to the smart card subsystem (for the active user) by adding it to the smart card database.
 //! \exception SCardException Thrown when a Card error condition occurs and throwErrors is set true.
 //! \param[in]          cardName             Name of the card.
 //! \param[in]          guidInterfaces       Array of identifiers (GUIDs) that identify the interfaces supported by the smart card.
 //! \param[in]          cardAtr              The card ATR.
 //! \param[in]          cardAtrMask          The card ATR mask.
 //! \param[in,out] pguidPrimaryProvider If non-null, the pointer to the identifier (GUID) for the smart card's primary service provider.
 ...
 //! \fn void WinSCard::IntroduceCardType(const std::wstring& cardName, const std::vector<GUID>& guidInterfaces, const std::vector<BYTE>& cardAtr, LPCGUID pguidPrimaryProvider)
 //! \brief Introduces a smart card to the smart card subsystem (for the active user) by adding it to the smart card database. Match by ATR and interfaces specified.
 //! \exception SCardException Thrown when a Card error condition occurs and throwErrors is set true.
 //! \param[in]          cardName             Name of the card.
 //! \param[in]          guidInterfaces       Array of identifiers (GUIDs) that identify the interfaces supported by the smart card.
 //! \param[in]          cardAtr              The card ATR.
 ...
 //! \fn void WinSCard::IntroduceCardType(const std::wstring& cardName, const std::vector<BYTE>& cardAtr, const std::vector<BYTE>& cardAtrMask, LPCGUID pguidPrimaryProvider)
 //! \brief Introduces a smart card to the smart card subsystem (for the active user) by adding it to the smart card database. Match by ATR and ATR mask.
 //! \exception SCardException Thrown when a Card error condition occurs and throwErrors is set true.
 //! \param[in]          cardName             Name of the card.
 //! \param[in]          cardAtr              The card ATR.
 //! \param[in]          cardAtrMask          The card ATR mask.
 ...
 //! \fn void WinSCard::IntroduceCardType(const std::wstring& cardName, const std::vector<BYTE>& cardAtr, LPCGUID pguidPrimaryProvider)
 //! \brief Introduces a smart card to the smart card subsystem (for the active user) by adding it to the smart card database. Match by ATR.
 //! \exception SCardException Thrown when a Card error condition occurs and throwErrors is set true.
 //! \param[in]          cardName             Name of the card.
 //! \param[in]          cardAtr              The card ATR.
 //! \param[in,out] pguidPrimaryProvider If non-null, the pointer to the identifier (GUID) for the smart card's primary service provider.
 ...
 //! \fn void WinSCard::LocateCards(const std::vector<std::wstring>& cards, ReadersStates& readerStates)
 //! \brief Searches the readers listed in the readerStates parameter for a card with an ATR string that matches one of the card names specified in cards, returning immediately with the result.
 //! \exception SCardException Thrown when a Card error condition occurs and throwErrors is set true.
 //! \param[in]          cards        The cards names list.
 //! \param[in,out] readerStates Class contains states of the readers.
 virtual void LocateCards(const std::vector<std::wstring>& cards, ReadersStates& readerStates);
 //! \fn void WinSCard::LocateCardsByATR(const std::vector<std::pair<std::vector<BYTE>, std::vector<BYTE>>>& atrMask, ReadersStates& readerStates)
 //! \brief Searches the readers listed in the readerStates parameter for a card with a name that matches one of the card names contained in one of the pair ATR and ATRMask specified by the atrMask parameter.
 //! \exception SCardException Thrown when a Card error condition occurs and throwErrors is set true.
 //! \param[in]          atrMask      Vector of pairs - ATR and ATRMask.
 //! \param[in,out] readerStates Class contains states of the readers.
 ...
 //! \fn void WinSCard::CardCancel()
 //! \brief Terminates all outstanding actions within a specific resource manager context.
 //! \details The only requests that you can cancel are those that require waiting for external action by the smart card or user.
 //! \details Any such outstanding action requests will terminate with a status indication that the action was canceled.
 //! \details This is especially useful to force outstanding GetStatusChange calls to terminate.
 //! \exception SCardException Thrown when a Card error condition occurs and throwErrors is set true.
 //! @}
